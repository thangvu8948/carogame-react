      ...
      <Router>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/profile"
            component={currentUser ? UserInfo : Login}
          />
          <Route
            path="/profile/:id/battles"
            render={
              currentUser
                ? () => (
                    <Battle userid={AccountService.getCurrentUserInfo().ID} />
                  )
                : () => Login
            }
          />
          <Route
            path="/battles/:id"
            component={currentUser ? DetailBattle : Login}
          />
          <Route
            exact
            path="/splash/:token"
          ...
          <Route
            path="/leaderboard"
            component={currentUser ? LeaderBoard : Login}
          />
          ...
          <Route
            ...
            render={(props) => {
              return <ChangePassword code={props.match.params.code} />;
            }}
          />
        </Switch>
      </Router>
